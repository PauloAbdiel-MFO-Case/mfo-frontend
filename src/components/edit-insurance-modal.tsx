...
export function EditInsuranceModal({ insurance, versionId, isOpen, onClose }: EditInsuranceModalProps) {
  ...
  const { mutate: updateInsurance, isPending } = useUpdateInsurance();

  const onSubmit = (values: z.infer<typeof formSchema>) => {
    if (!insurance || !versionId) return;
